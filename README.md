...
The Flex MTL codebase is separated into two parts: **velocity templates**, and **skeleton library**.
...
Each of the files above are loaded through a separate dependency, defined in `lib_configs.vm` in the Flex MTL. 
